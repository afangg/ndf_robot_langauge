            ...
            if self.mc_vis is not None and visualize:
                if i % 50 != 0:
                    ...
                    for ii in range(M):
                        ...
                        util.meshcat_pcd_show(self.mc_vis, Xii, color=[0, 0, 0], name=f'optimizer/X_{ii}')
                        util.meshcat_frame_show(self.mc_vis, f'optimizer/X_{ii}_frame', transform_ii_full, length=0.05, radius=0.002, opacity=0.9)
                        viz_i += 1
