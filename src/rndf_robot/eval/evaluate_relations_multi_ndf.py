...
def main(args):
    ...
    for iteration in range(args.start_iteration, args.num_iterations):
        ...
        with recorder.meshcat_scene_lock:
            util.meshcat_pcd_show(mc_vis, child_pcd, color=[255, 0, 255], name='scene/child_pcd')
            util.meshcat_pcd_show(mc_vis, parent_pcd, color=[0, 0, 255], name='scene/parent_pcd')
        ...
        with recorder.meshcat_scene_lock:
            util.meshcat_pcd_show(mc_vis, final_child_pcd, color=[255, 0, 255], name='scene/child_pcd')
