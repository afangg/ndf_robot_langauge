...
class RealsenseCalibrationLocal:
    def __init__(self):
...
def main(args):
    ...
    calib_package_path = osp.join(path_util.get_rndf_src(), 'robot/camera_calibration_files')
    ...
    pipelines = enable_devices([serials[args.cam_index]], ctx, resolution_width, resolution_height, frame_rate)
    ...
    while not done:
        ...
        # for idx, cam_and_subs in enumerate(img_subscribers):
            ...
            calib = RealsenseCalibrationLocal()
