...
def filter_pcds(pcds, scores, bounds=None, mean_inliers=False, downsample=False, show=False):
    filtered_pcds = []
    filtered_scores = []
...
def manually_segment_pcd(full_pcd, bounds=None, mean_inliers=False, downsample=False, show=False):
    crop_pcd = full_pcd
