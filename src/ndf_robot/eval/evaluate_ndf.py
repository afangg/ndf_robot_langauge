...
def main(args, global_dict):
    ...
    for iteration in range(args.start_iteration, args.num_iterations):
        ...
        final_pcd = util.transform_pcd(target_obj_pcd_obs, rack_pose_mats[best_idx])
        trimesh_util.trimesh_show([target_obj_pcd_obs, final_pcd], show=True)
        ...
        for g_idx in range(2):
            ...
            time.sleep(0.5)
            txt = input('Press enter to continue 0')
            ...
            txt = input('Press enter to continue 1')
            ...
            if grasp_jnt_pos is not None and jnt_pos is not None:
                if g_idx == 0:
                    ...
                    txt = input('Press enter to continue 2')
                ...
                if grasp_plan is None:
                    ...
                    if plan1 is not None and plan2 is not None:
                        ...
                        txt = input('Press enter to continue 3')
                        ...
                        safeCollisionFilterPair(obj_id, table_id, -1, -1, enableCollision=False)
                        time.sleep(0.8)
                        txt = input('Press enter to continue 4')
                        ...
                        if g_idx == 1:
                            ...
                            # turn OFF collisions between object / table and object / rack, and move to pre-place pose
                                ...
                                txt = input('Press enter to continue 5')
                        ...
                        txt = input('Press enter to continue 6')
