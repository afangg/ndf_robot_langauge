...
def main(args, global_dict):
    ...
    test_object_ids = []
    clutter_obj_dirs = [path for path in path_util.get_ndf_obj_descriptions() if '_centered_obj_normalized' in path and obj_class not in path] 
    # clutter_obj_dirs = osp.join(path_util.get_ndf_obj_descriptions(), obj_class + '_centered_obj_normalized')
